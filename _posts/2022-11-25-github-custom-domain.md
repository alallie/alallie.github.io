...
Unplublishing the pages did not resolve the issue. I had to take it once step further to delete the `github-pages` entry from the Environments in the repo settings. Once that was gone and I redeployed the site, it started working.
